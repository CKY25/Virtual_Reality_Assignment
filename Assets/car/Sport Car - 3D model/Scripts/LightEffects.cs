...
public class LightEffects : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        FLM.DisableKeyword(emission);
        TLM.DisableKeyword(emission);
        RLM.DisableKeyword(emission);
        ILM.DisableKeyword(emission);
        IRM.DisableKeyword(emission);
    }
